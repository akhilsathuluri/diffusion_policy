...
class MultiPushTImageRunner(BaseImageRunner):
    def __init__(
        self,
        output_dir,
        n_train=10,
        ...
        def env_fn():
            return MultiStepWrapper(
                VideoRecordingWrapper(
                    MultiPushTImageEnv(legacy=legacy_test, render_size=render_size),
    ...
    def run(self, policy: BaseImagePolicy):
        ...
        for chunk_idx in range(n_chunks):
            ...
            pbar = tqdm.tqdm(
                ...
                desc=f"Eval MultiPushtImageRunner {chunk_idx+1}/{n_chunks}",
                leave=False,
